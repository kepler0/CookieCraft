...
public class CCraft {
  static {
    try {
      loadLibraryFromJar("/lib/libmain.so");
    } catch(IOException e) {
      e.printStackTrace();
    }
  }
  ...
  *
  * Taken from: http://frommyplayground.com/how-to-load-native-jni-library-from-jar/
  *
  ...
  */
  public static void loadLibraryFromJar(String path) throws IOException {
    ...
    InputStream is = CCraft.class.getResourceAsStream(path);
    if (is == null) {
